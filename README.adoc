...
image:https://ci.jenkins.io/job/Plugins/job/ircbot-plugin/job/main/badge/icon[link="https://ci.jenkins.io/job/Plugins/job/ircbot-plugin/job/master/" alt="Build Status"]
//////////
